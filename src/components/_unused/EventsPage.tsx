...
export function EventsPage() {
  ...
  const filteredAndSortedEvents = useMemo(() => {
    ...
    return filtered
  }, [events, sortBy, filterRaceType, filterOrganization, filterDivision, filterDifficulty, onlyHyrox, showPastEvents])
        ...
        <div className="sticky top-[64px] z-30 bg-black/60 backdrop-blur-sm pt-2 pb-4 mb-8 flex flex-wrap gap-4">
          ...
          <div>
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-white">Only HYROX workouts</span>
            </label>
          </div>
